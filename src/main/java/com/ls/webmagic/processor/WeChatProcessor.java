...
public class WeChatProcessor implements PageProcessor {
    ...
    private void saveNewsInfo(Page page) throws ParseException {
        ...
        for (Selectable node : nodes) {
            ...
            event.setCreateDate(new Date()); //爬取数据的当前时间
            event.setState(0);
    ...
    private Site site = Site.me()
            .setUserAgent("Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36")
            .setCharset("utf8")
            .setTimeOut(10 * 1000)
            .setRetryTimes(3)
